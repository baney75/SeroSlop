...
import { classifyM5Stage, M5_FAILURE_PATH, M5_FINAL_RECEIPT_PATH, M5_LARGE_SOURCE_LOCK_PATH, M5_P4_COMMIT, M5_RUNTIME_AUTHORIZATION_PATH, M5_RUNTIME_RECOVERY_EXPECTED, M5_SELECTION_LOCK_PATH, matchesExpectedRows } from "./m5-stage-policy.mjs";
...
const m5AuthorizationExists = existsSync(M5_RUNTIME_AUTHORIZATION_PATH);
...
const m5SourceRecoveryExists = m5HeadParent === M5_P4_COMMIT && matchesExpectedRows(m5HeadRows, M5_RUNTIME_RECOVERY_EXPECTED);
