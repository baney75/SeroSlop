...
const submissionProxyExists = (() => {
  try {
    ...
    return parents.length === 1 && (matchesM6SubmissionProxyResultRecoveryHead({ head, parent: parents[0], rows }) ||
      matchesM6SubmissionProxyResultHead({ head, parent: parents[0], rows }) ||
