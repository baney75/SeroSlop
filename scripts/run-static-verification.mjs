...
import { isM6ProtocolLineageHead, matchesM6SubmissionProxyRHead, matchesM6SubmissionProxyR2Head } from "./m6-stage-policy.mjs";
...
const submissionProxyExists = (() => {
  try {
    ...
    return parents.length === 1 && (matchesM6SubmissionProxyR2Head({ head, parent: parents[0], rows }) ||
